    ...
    <div className="w-full max-w-5xl flex flex-col gap-10 mx-auto px-4">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="w-full flex justify-center">
          <div className="w-[350px] h-[200px] relative" style={{ perspective: '1200px' }}>
            <div
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl shadow-md p-4">
          ...
          <ul className="space-y-2 text-sm text-blue-600">
            {records?.["com.twitter"] && (
              <li><a href={`https://twitter.com/${records["com.twitter"]}`} target="_blank">@{records["com.twitter"]}</a></li>
            )}
            {records?.["com.github"] && (
              <li><a href={`https://github.com/${records["com.github"]}`} target="_blank">@{records["com.github"]}</a></li>
            )}
            {records?.["org.telegram"] && (
              <li><a href={`https://t.me/${records["org.telegram"]}`} target="_blank">@{records["org.telegram"]}</a></li>
            )}
          </ul>
