  ...
  return (
    <div className="w-full max-w-5xl flex flex-col gap-10 mx-auto px-4">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 text-center flex flex-col items-center">
        ...
        {isPrimary && <p className="text-xs text-green-600 font-medium mt-1">✅ Primary Name</p>}
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="w-full flex justify-center">
          ...
          >
            ...
            >
              <div className="absolute inset-0 bg-white rounded-2xl shadow-xl flex flex-col justify-center items-center text-center px-4" style={{ backfaceVisibility: 'hidden' }}>
              ...
              <div className="absolute inset-0 bg-purple-100 rounded-2xl shadow-xl flex flex-col justify-center items-center text-center px-4" style={{ transform: 'rotateY(180deg)', backfaceVisibility: 'hidden' }}>
                <h3 className="text-lg font-semibold text-purple-700">Wallet Address</h3>
                <p className="text-sm break-all text-gray-700 mt-2">{address}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-4">
          ...
          <ul className="space-y-2 text-sm text-blue-600">
            {records["com.twitter"] && (
              <li><a href={`https://twitter.com/${records["com.twitter"]}`} target="_blank" rel="noreferrer">@{records["com.twitter"]}</a></li>
            )}
            {records["com.github"] && (
              <li><a href={`https://github.com/${records["com.github"]}`} target="_blank" rel="noreferrer">@{records["com.github"]}</a></li>
            )}
            {records["org.telegram"] && (
              <li><a href={`https://t.me/${records["org.telegram"]}`} target="_blank" rel="noreferrer">@{records["org.telegram"]}</a></li>
            )}
          </ul>
